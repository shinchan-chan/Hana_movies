...
@Bot.on_message(filters.private & filters.user(ADMINS) & ~filters.command(['start','users','broadcast','batch','genlink','stats', 'add_premium', 'remove_premium', 'list_premium','pbroadcast', 'add_admin', 'deladmin', 'admins']))
